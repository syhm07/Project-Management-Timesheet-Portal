...
class EmployeeManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('employees.*', 'department.name as department_name', 'department.id as department_id', 'division.name as division_name', 'division.id as division_id', 'city.id as city_id', 'city.name as city_name')
        ->paginate(5);
    ...
    public function create()
    {
        ...
        'states' => $states, 'cities' => $cities, 'departments' => $departments, 'divisions' => $divisions]);
    }
